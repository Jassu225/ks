...
**Delivery is part of finishing.** A completed report that the caller never hears about is a wasted run — this has happened: a good report sat on disk while the caller redid the work. Say where it is, and never acknowledge a stand-down while holding one.
