...
**Output:** User stories document at `{project-directory-path}/resources/user-stories.md`
...
Ask clarifying questions iteratively until the user confirms they are satisfied. Focus on:
...
```markdown
### US-001: [Title]
**Feature:** [User flow this story belongs to]
**Description:** As a [user], I want [feature] so that [benefit].
...
**Note:** Multiple user stories that form one user flow should share the same Feature name. This helps group related stories together.
