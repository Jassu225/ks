...
7. **Ticket workflow only**: Tell the user: "Phase 9 (Implementation Plan Creation) uses semantic code analysis and plannotator. Please start a new session with `claude-ks-serena-plannotator` to proceed."
...
**Ticket workflow**: Phase 9: Implementation Plan Creation — user should launch with `claude-ks-serena-plannotator`.
